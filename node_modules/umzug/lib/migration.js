...
module.exports = class Migration {
  ...
  migration() {
    ...
    if (this.path.match(/\.coffee$/)) {
      ...
      import(_helper.default.resolve('coffeescript/register') ||
        // 1.7.x compiler registration
        _helper.default.resolve('coffee-script/register') ||
        // Prior to 1.7.x compiler registration
        _helper.default.resolve('coffee-script')).catch(() => {
          console.error('You have to add "coffee-script" to your package.json.');
          process.exit(1);
        });
    }
  
    return import(this.path).then(module => module.default || module);
  }
